...
def model_selection_h3(train_file, test_file, model_output_path="models/random_forest_h3.pkl"):
    """
    Führt die Modellauswahl für Hypothese 3 durch und speichert das beste Modell.
    ...
    """
    print("Starte Modellauswahl für Hypothese 3...")
    train_data = pd.read_csv(train_file)
    test_data = pd.read_csv(test_file)

    # Prüfen, ob die notwendigen Features vorhanden sind
    required_features = ["hour", "weekday", "is_weekend", "peak_consumption_lag1", "peak_consumption_lag2"]
...
if __name__ == "__main__":
    # Hypothese 3
    train_file_h3 = "data/h3_train.csv"
    test_file_h3 = "data/h3_test.csv"
